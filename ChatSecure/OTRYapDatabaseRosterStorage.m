...
- (void)handleRosterItem:(NSXMLElement *)item xmppStream:(XMPPStream *)stream
{
    ...
    //  NSLog(@"handleRosterItem %@, %@", [jid bare], [[stream myJID] bare]);
...
- (void)handlePresence:(XMPPPresence *)presence xmppStream:(XMPPStream *)stream
{
    ...
    //Вот когда я иправлю эту хуйню тогда у меня не будет фатомных групповых контактов zigzagcorp bug
