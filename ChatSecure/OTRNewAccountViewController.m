...
- (NSArray*)accounts
{
    ...
    // Тут показываю только safejab zigzagcorp
    ...
    return @[
            ...
            // [OTRNewAccountViewController googleCellDictionary],
             ...
             [OTRNewAccountViewController securCellDictionary]
             ];
}
...
+(NSDictionary *)securCellDictionary { //zigzagcorp dict
    return @{kOTRDisplayNameKey: SECUR_STRING,
             kOTRProviderImageKey: [UIImage imageNamed:securImage],
             kOTRAccountTypeKey: @(OTRAccountTypeSecurName)};
}
